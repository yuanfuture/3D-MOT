...
class Kitti2DBox(_BaseDataset):
    ...
    def get_default_dataset_config():
        ...
        # /media/lab509-2/6t/ZRL/CasTrack/evaluation_HOTA
    ...
    def __init__(self, config=None):
        ...
        self.class_name_to_class_id = {'car': 2, 'van': 4, 'truck': 6, 'pedestrian': 1, 'person': 5,  # person sitting
                                       'cyclist': 3, 'tram': 7, 'misc': 8, 'dontcare': 9, 'car_2': 10}
